...
gem 'sinatra-activerecord', '~> 2.0', '>= 2.0.14',                                 require: ['sinatra/activerecord', 'active_support/security_utils'] # => Integrates ActiveRecord into Sinatra apps (I changed for AR6+)
